...
public class TestCongito {
    protected static final String URL_PREFIX = "url-prefix";
    ...
    public static void main(String[] args) {
        TestCongito testCongito = new TestCongito();

        try {
            AWSSessionCredentials credentials = testCongito.authenticate(
