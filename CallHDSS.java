...
public class CallHDSS {
     ...
     */
    public String post(String url, String method, String payload, String accessKey, String secretKey, String sessionToken) throws IOException {
        String apiKey = null;
        Integer httpStatusCodeExpected = 200;
        return request(accessKey, secretKey, url + method, apiKey, sessionToken, payload, httpStatusCodeExpected);
    }
    ...
    private static String request(String accessKeyId, String accessKeySecret, String urlText, String apiKey,
        ...
        try {
            ...
            try (Reader sr = new InputStreamReader(in, CHARSET_UTF8)) {
                @SuppressWarnings("resource") Scanner scanner = new Scanner(sr);
                try {
